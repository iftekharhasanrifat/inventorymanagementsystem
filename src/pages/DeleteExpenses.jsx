...
const DeleteExpenses = () => {
  ...
  const handleDeleteExpense = () => {
    setLoading(true);
    axios
      .delete(`https://inventory-management-ba-git-4e9e06-iftekharhasanrifats-projects.vercel.app/expenses/${id}`)
      .then(() => {
        setLoading(false);
  ...
  return (
    <div className="p-6">
      <BackButton />
      <h1 className="text-3xl my-6 text-center font-semibold text-gray-700">Delete Expense</h1>
      ...
      <div className="flex flex-col items-center border-2 border-rose-500 bg-white rounded-xl max-w-md mx-auto p-6 shadow-lg">
        <h3 className="text-2xl text-gray-800 font-semibold text-center">
          ⚠️ Are you sure you want to delete this data?
        </h3>
