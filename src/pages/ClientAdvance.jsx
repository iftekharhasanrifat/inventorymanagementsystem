...
const handleUpdateClients = () => {
  ...
  axios
    .post(`https://inventory-management-ba-git-4e9e06-iftekharhasanrifats-projects.vercel.app/clients/advance`, data)
    .then(() => {
      setLoading(false);
      navigate('/clients/show');
    })
  ...
  return (
    <div className='p-4'>
      <BackButton />
      <h1 className='text-3xl my-4 text-center'>Advance Payment</h1>
