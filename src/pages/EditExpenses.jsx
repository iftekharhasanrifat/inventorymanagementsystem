...
const EditExpenses = () => {
  ...
  const navigate = useNavigate();
    const [errors, setErrors] = useState({
     ...
     useEffect(() => {
  axios
    .get(`https://inventory-management-ba-git-4e9e06-iftekharhasanrifats-projects.vercel.app/expenses/${id}`) // Fetching the item details by ID
    .then((res) => {
  ...
  if (!isValid) return;
    ...
    setLoading(true);
    axios
      .put(`https://inventory-management-ba-git-4e9e06-iftekharhasanrifats-projects.vercel.app/expenses/${id}`, data)
      .then(() => {
        setLoading(false);
  ...
  return (
    <div className='p-4'>
      <BackButton />
      <h1 className='text-3xl my-4 text-center'>Edit Expenses</h1>
