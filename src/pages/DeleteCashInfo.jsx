...
const DeleteExpenses = () => {
  ...
  const handleDeleteCashInfo = () => {
    setLoading(true);
    axios
      .delete(`https://inventory-management-ba-git-4e9e06-iftekharhasanrifats-projects.vercel.app/cashinfo/${id}`)
      .then(() => {
        setLoading(false);
  ...
  return (
    <div className="p-6">
      <BackButton />
      <h1 className="text-3xl my-6 text-center font-semibold text-gray-700">Delete CashInfo</h1>
