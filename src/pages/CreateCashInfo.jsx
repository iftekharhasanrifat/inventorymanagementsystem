...
const CreateCashInfo = () => {
  ...
  const handleSaveCashInfo = () => {
    ...
    if (!bankAmount || isNaN(bankAmount) || bankAmount < 0) {
  ...
  if (!isValid) return;
    ...
    setLoading(true);
    axios
      .post('https://inventory-management-ba-git-4e9e06-iftekharhasanrifats-projects.vercel.app/cashinfo', data)
      .then(() => {
        setLoading(false);
  ...
  return (
    <div className='p-4'>
      <BackButton />
      <h1 className='text-3xl my-4 text-center'>Create Cashinfo</h1>
